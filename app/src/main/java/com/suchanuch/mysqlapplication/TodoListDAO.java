...
public class TodoListDAO {
    ...
    public void update(TodoList todoList) {
        ...
        // this.database.rawQuery("UPDATE tbtodo_list SET taskname = " + text + "WHERE taskid = " + id, null);
    ...
    public void delete(TodoList todoList) {
        ...
        String sqlDel = "DELETE FROM tbtodo_list WHERE taskid=" + delTodoList.getTaskid();
        this.database.execSQL(sqlDel);
